...
const Toolbar: React.FC<ToolbarProps> = ({ 
  ...
  return (
    <div className="flex flex-col items-center gap-6 animate-in slide-in-from-bottom-8 duration-700">
      ...
      {/* Zoom Slider */}
      <div className="w-64 flex items-center gap-4 bg-white px-5 py-3 rounded-2xl border border-slate-200 shadow-sm">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <div className="flex items-center bg-white border border-slate-200 rounded-2xl p-1.5 shadow-sm">
          ...
          >
             <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4 4L20 20M20 4L4 20" />
            </svg>
          </button>
        </div>
